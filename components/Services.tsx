    ...
    <div className='py-20 relative z-[20]' id='projects'>
        ...
        <div className='flex flex-wrap items-center justify-center p-4 gap-x-24 gap-y-16 mt-10'>
            {services.map((services) => (
                <div key={services.id} className='sm:h-[41rem] h-[32rem] flex items-center justify-center sm:w-[30.625rem] w-[85vw] px-4 sm:px-0'>
                    <PinContainer title={services.link} href={services.link} target={"_blank"} rel={"noopener noreferrer"} >
